...
J1 <- read.table('~/GTRD/brain_trn/Jaspar_coords/j5.tsv',sep='\t',header = T)
...
fetal_brain_hts5 <- fetal_brain_hts
#fetal_brain_hts <- fetal_brain_hts_o

save(fetal_brain_hts5, file='~/GTRD/final_gtrd/fetal_brain/fetal_brain_hts5.RData')
