...
J1 <- read.table('~/GTRD/brain_trn/Jaspar_coords/j8.tsv',sep='\t',header = T)
...
fetal_brain_hts8 <- fetal_brain_hts
#fetal_brain_hts <- fetal_brain_hts_o

save(fetal_brain_hts8, file='~/GTRD/final_gtrd/fetal_brain/fetal_brain_hts8.RData')
