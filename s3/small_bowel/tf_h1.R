...
intestine_hts$queryHits <- tf_j[intestine_hts$queryHits,'motif_id']
intestine_hts$subjectHits <- grch38[intestine_hts$subjectHits, 'symbol' ]
intestine_hts <- unique(intestine_hts)
intestine_hts_h1 <- intestine_hts
#brain_hts <- brain_hts_o

save(intestine_hts_h1, file='~/GTRD/final_gtrd/intestine/intestine_hts_h1.RData')
