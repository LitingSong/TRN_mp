...
hippocampus_hts$queryHits <- tf_j[hippocampus_hts$queryHits,'motif_id']
hippocampus_hts$subjectHits <- grch38[hippocampus_hts$subjectHits, 'symbol' ]
hippocampus_hts <- unique(hippocampus_hts)
hippocampus_hts_s1 <- hippocampus_hts
#brain_hts <- brain_hts_o

save(hippocampus_hts_s1, file='~/GTRD/final_gtrd/hippocampus/hippocampus_hts_s1.RData')
